    ...
    public partial class Options : Form
    {
        ...
        private bool applySettings()
        {
            ...
            else
            {
                ...
                settings.LFDModule = cb_lfdModule.Checked;
                settings.LFRModule = cb_lfrModule.Checked;
                settings.BGModule = cb_bgModule.Checked;
        ...
        public void overwriteControlsFromSettings()
        {
            ...
            cb_lfdModule.Checked = settings.LFDModule;
            cb_lfrModule.Checked = settings.LFRModule;
            cb_bgModule.Checked = settings.BGModule;
